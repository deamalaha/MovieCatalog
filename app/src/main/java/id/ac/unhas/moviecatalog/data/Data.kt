...
object Data {
    ...
    fun generateMovies(): List<MovieAndShowEntity>{

        val movies = ArrayList<MovieAndShowEntity>()

        movies.add(MovieAndShowEntity("Enola Holmes",
        "2020",
        ...
        movies.add(MovieAndShowEntity("Godzilla vs Kong",
        ...
        movies.add(
            MovieAndShowEntity("Kimi no Na Wa",
        "2016",
        "fantasy, romance",
        ...
        movies.add(MovieAndShowEntity("Mine",
            "2016",
            "physological thrillers",
        ...
        movies.add(MovieAndShowEntity("Tall Girl",
            "2019",
            "romance, comedy",
        ...
        R.drawable.tall_girl))

        movies.add(MovieAndShowEntity("Tenki no Ko",
            "2019",
            "romance, fantasy",
        ...
        R.drawable.tenki_no_ko))

        movies.add(MovieAndShowEntity("The Kissing Booth",
            "2018",
            "romantic comedy",
            ...
            R.drawable.the_kissing_booth))

        return movies
    }

    fun generateTvShows() : List<MovieAndShowEntity> {

        val tvShow = ArrayList<MovieAndShowEntity>()

        tvShow.add(
            MovieAndShowEntity("Stranger Things",
        "2016",
        ...
        tvShow.add(
            MovieAndShowEntity("Shokugeki No Souma",
                "2015",
                "action, comedy",
        ...
        tvShow.add(
            MovieAndShowEntity("Detective Conan ",
                "",
                "mystery, action",
                "",
        ...
        tvShow.add(
            MovieAndShowEntity("The Walking Dead",
                "myster, action, thriller",
                "2010",
        ...
        tvShow.add(
            MovieAndShowEntity("Your Lie In April",
                "romance",
                "2016",
            ...
            R.drawable.your_lie_in_april)
        )

        tvShow.add(
            MovieAndShowEntity("Anohana",
                "2011",
